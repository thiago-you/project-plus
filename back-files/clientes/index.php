        ...
        <?php
                        ...
                        return '
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12"> 
                                    <b>Endereço: </b>'.$model->enderecoCompleto.'
                                </div>
                            </div>
                            <div class="row">
            ...
            echo GridView::widget([
                ...
                'toolbar' => [
                    ...
                    ['content' => Html::button('<i class="fa fa-file-pdf"></i> Relatório', ['id' => 'btnRelatorio', 'class' => Util::BTN_COLOR_PURPLE, 'data-toggle' => 'tooltip', 'title' => 'Gerar Relatório de Clientes'])],
